...
<body class="student-page grade-<?php echo $g; ?> ui-mode-K-2">
    <header class="student-header">
        ...
        <div class="header-right" style="display: flex; align-items: center; gap: 20px;">
            <div class="points-badge pulse-anim"><i class="fas fa-coins"></i> <span id="student-points"><?php echo $_SESSION['points'] ?? 0; ?></span> Points</div>
